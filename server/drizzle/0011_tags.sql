...
CREATE UNIQUE INDEX "tags_project_name_unique" ON "tags" USING btree ("project_id","name");--> statement-breakpoint
CREATE INDEX "words_to_tags_tag_id_idx" ON "words_to_tags" USING btree ("tag_id");